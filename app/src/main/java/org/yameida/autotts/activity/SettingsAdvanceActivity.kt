...
class SettingsAdvanceActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        rl_corp.setOnClickListener { showBrowserTypeDialog() }
    ...
    private fun showBrowserTypeDialog() {
        val strategyArray = arrayOf("百度浏览器", "QQ浏览器", "UC浏览器", "夸克浏览器", "搜狗浏览器")
            ...
            .addItems(strategyArray) { dialog, which ->
                ...
                when (which) {
                    Constant.BROWSER_TYPE_BAIDU -> {
                        ToastUtils.showLong("设置为百度浏览器")
                    }
                    Constant.BROWSER_TYPE_QQ -> {
                        ToastUtils.showLong("设置为QQ浏览器")
                    }
                    Constant.BROWSER_TYPE_UC -> {
                        ToastUtils.showLong("设置为UC浏览器")
                    }
                    Constant.BROWSER_TYPE_KK -> {
                        ToastUtils.showLong("设置为夸克浏览器")
                    }
                    Constant.BROWSER_TYPE_SG -> {
                        ToastUtils.showLong("设置为搜狗浏览器")
                    }
                }
                Constant.browserType = which
            }
            .setCheckedIndex(Constant.browserType)
